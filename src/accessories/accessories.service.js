...
class Accessory {
  ...
  getService() {
    ...
    this.turboModeSwitchService.updateCharacteristic(this.api.hap.Characteristic.Name, 'Turbo Mode');
    ...
    this.sleepModeSwitchService.updateCharacteristic(this.api.hap.Characteristic.Name, 'Sleep Mode');
